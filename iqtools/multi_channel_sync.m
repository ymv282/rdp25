...
for k = 1:size(wfms,1)
    iqdownload(complex(wfms{k,1},wfms{k,2}), fs, 'arbConfig', awg1, 'keepOpen', 1, 'run', 0, 'segmentNumber', testSegNum+k-1);
end
...
for k = 1:size(wfms,1)
    iqdownload(complex(wfms{k,3},wfms{k,4}), fs, 'arbConfig', awg2, 'keepOpen', 1, 'run', 0, 'segmentNumber', testSegNum+k-1);
end
