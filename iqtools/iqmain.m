...
% Last Modified by GUIDE v2.5 11-Jul-2015 12:01:15
...
if (~isempty(arbConfig))
    if (~isempty(strfind(arbConfig.model, 'M8190')))
        set(handles.pushbuttonM8190ADemos, 'String', regexprep(get(handles.pushbuttonM8190ADemos, 'String'), 'M8195', 'M8190'));
    ...
    elseif (~isempty(strfind(arbConfig.model, 'M8195')))
        set(handles.pushbuttonM8190ADemos, 'String', regexprep(get(handles.pushbuttonM8190ADemos, 'String'), 'M8190', 'M8195'));
        set(handles.pushbuttonM8190ADemos, 'Enable', 'on');
...
if (isfield(handles, 'AWGSpecificFunctions') && handles.AWGSpecificFunctions && ~isempty(arbConfig) && ...
        (~isempty(strfind(arbConfig.model, 'M8190')) || ~isempty(strfind(arbConfig.model, 'M8195'))))
    pos(3) = 472;
