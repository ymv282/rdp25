...
arbModels = cellstr(get(handles.popupmenuModel, 'String'));
arbModel = arbModels{get(handles.popupmenuModel, 'Value')};
% M8195A_Rev1 offers global frequency/phase correction
isM8195ARev1 = ~isempty(strfind(arbModel, 'M8195A_Rev1'));
set(handles.textAmplScale, 'Visible', onoff{2 - isM8195ARev1});
set(handles.popupmenuAmplScale, 'Visible', onoff{2 - isM8195ARev1});
set(handles.editAmplScale, 'Visible', onoff{2 - isM8195ARev1});
set(handles.textCarrierFreq, 'Visible', onoff{2 - isM8195ARev1});
set(handles.editCarrierFreq, 'Visible', onoff{2 - isM8195ARev1});
set(handles.checkboxSetCarrierFreq, 'Visible', onoff{2 - isM8195ARev1});
set(handles.checkboxM8195Acorr, 'Visible', onoff{1 + isM8195ARev1});
...
% RST is only implemented for M8190A and 81180A/B
if ((~isempty(strfind(arbModel, 'M8195A_Rev1'))) || ...
...
% amplitude/offset for M8195A_Rev1, M8190A, 81180A, 81150A, 81160A, 33xxx
if (~isempty(strfind(arbModel, 'M8195A_Rev1')) || ...
...
if (~isempty(strfind(model, 'M8190')))
    checkmodel = 'M8190A';
elseif (~isempty(strfind(model, 'M8195A_Rev1')))
    checkmodel = 'M8195A';
